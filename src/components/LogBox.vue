    ...
    <div class="form-container">
      ...
      <div class="form-inner">
        ...
        <form action="#" class="signup">
          <div class="field">
            <input type="text" id="User_Regis" placeholder="อีเมล" required>
          </div>
          <div class="field">
            <input type="password" id="User_pass1" placeholder="รหัสผ่าน" required>
          </div>
          <div class="field">
            <input type="password" id="User_pass2" placeholder="ยืนยันรหัสผ่าน" required>
          </div>
          <div class="field btn">
            <div class="btn-layer"></div>
            <input type="submit" value="ลงทะเบียน" @click="Register_to">
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  methods: {
    Login_to() {
      ...
      const email = document.getElementById('User_Regis').value;
      const password1 = document.getElementById('User_pass1').value;
      const password2 = document.getElementById('User_pass2').value;
